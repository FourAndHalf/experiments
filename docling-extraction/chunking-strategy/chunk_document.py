...
def generate_rag_chunks(input_json_path: str, output_json_path: str):
    """
    Reads a Docling extracted JSON file, chunks it hierarchically, 
...
if __name__ == "__main__":
    ...
    generate_rag_chunks(INPUT_FILE, OUTPUT_FILE)
